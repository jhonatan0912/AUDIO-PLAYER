import { Song } from "./app/models/Song.interface";

export const data: Song[] = [
  {
    image: 'https://i1.sndcdn.com/artworks-000387420762-j7ora1-t500x500.jpg',
    title: 'Honest',
  ...
  {
    image: "https://indierocks.b-cdn.net/wp-content/uploads/2021/11/WOS_Oscuro-%C3%89xtasis_portada.jpg",
    title: "Mirá mamá",
    artist: "WOS",
    album: "Oscuro éxtasis",
    url: "/assets/mira-mama.mp3",
    lyrics: `
...
Y te juro que no hay nada más
  ...
  {
    image: 'https://i1.sndcdn.com/artworks-000415233780-bcyvx7-t500x500.jpg',
    title: 'Andromeda',
    artist: 'WOS',
    album: 'ANDRÓMEDA',
    url: '/assets/andromeda-wos.mp3',
    lyrics: `
    
    `
  },
  {
    image: 'https://loqueva.com/wp-content/uploads/2019/03/Wos-Terraza-Picante-loqueva-home.jpg',
    title: 'Terraza',
    artist: 'Wos',
    album: 'Terraza',
    url: '/assets/terraza-wos.mp3',
    lyrics: `
...
Sale al rescate lo verdadero
  ...
  {
    image: 'https://i1.sndcdn.com/artworks-Ipy9cNUrIJz5ApLQ-uZrrAg-t500x500.jpg',
    title: 'Alma dinamita',
    artist: 'WOS',
    album: 'Tres puntos suspensivos',
    url: '/assets/alma-dinamita-wos.mp3',
    lyrics: `
 Me gusta todo lo que sos y un poco más
El barrio queda sin luz cuando no estás
Las caras cambian todas cuando vos llegás
...
Entre desastres y prisioneros
Cuando el destino se pone austero
Sale al rescate lo verdade
    `
  },
  {
    image: 'https://indiehoy.com/wp-content/uploads/2019/10/wos-caravana.jpg',
    title: 'Melon vino',
    artist: 'WOS',
    album: 'Caravana',
    url: '/assets/melon-vino-wos.mp3',
    lyrics: `
...
Siempre vuelvo con mi sombra (ah)
Te invito a que la conozcas, ah
Me revuelco con mi sombra (ah)
...
Tengo estudio y un colchón, tengo amigos, un montón
Tengo vino y un melón, ready para el vacilón, ey
Tengo, gano, busco, voy, rompo todo lo que soy, wah
Estoy sentado, esperando que se pase el rato
Estas palabras se parecen a mi autorretrato
Ey, hoy ya no quiero hablar
Si las sensaciones que en serio cambiaron mi vida
...
Para ir por ahí, vamo' en mi zepelín
...
Cuando esta vida rara y descarada se lleve puesto a algún amigo
Cuando lo más común pierda sentido, siempre vas a poder venir conmigo
Mmm-mmm, nuestra mirada es la fuerza más linda de todas
